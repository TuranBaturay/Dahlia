    ...
    def set_text(self, text):
        ...
        if text:
            if self.text_panel.align == "center":
                self.text_panel.text_rect.centerx = (
                    self.text_panel.text_rect.inflate(-5, 0)
                    .move(self.box.w + 10, 0)
                    .centerx
                )
                # print(text,"center")
                ...
                # print(text,"left")
                self.text_panel.text_rect.left = (
                    self.box.w + 10 + self.text_panel.padding
                )
            elif self.text_panel.align == "right":
                self.text_panel.text_rect.right = (
                    self.text_panel.text_rect.w - self.text_panel.padding
                )
